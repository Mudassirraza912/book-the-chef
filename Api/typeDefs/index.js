...
module.exports = gql`
  ...
  type Resturant {
    ...
    business_hours_week: WeekBusinessHours
  ...
  input BusinessHoursWeekInput {
    mon: BusinessHourWeekInput!
    tue: BusinessHourWeekInput!
    wed: BusinessHourWeekInput!
    thu: BusinessHourWeekInput!
    fri: BusinessHourWeekInput!
    sat: BusinessHourWeekInput!
    sun: BusinessHourWeekInput!
  }
  ...
  type Mutation {
    ...
    updateResturantBussinessHourWeek(
      resturantId: String
      weekHours: BusinessHoursWeekInput!
    ): WeekBusinessHours!
    ...
    setSelectedChef(resturantId: String, chefId: String): Resturant! 
