        ...
        <div className="active-resturants">
            ...
            <ViewModal show={modal}>
                ...
                <div className="active-view-details">
                    ...
                    <h2>Bank Account</h2>
                    {viewResturant.bank_account ?
                        <>
                            <p>Account Holder Name : {viewResturant.bank_account.accountHolderName}</p>
                            <p>Bank Name : {viewResturant.bank_account.bankName}</p>
                            <p>Account Number : {viewResturant.bank_account.accountNumber}</p>
                            <p>Sort Code : {viewResturant.bank_account.sortCode}</p>
                        </>
